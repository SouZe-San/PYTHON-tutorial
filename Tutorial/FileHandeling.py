...
# --> in the file this contain have write,,,, if any contain present in the file then it Over writes the contents of the file
...
# FIle Open For Append operation by this operation the previous content stay as it was and add extra items..
...
if ("INFO" in contain):  # if Occur any Lowercase/UpperCase problem then transform in One type .lower()
    print("found")
    # the Contain change but not in File
    contain = contain.replace("INFO", "info")
else:
    print("Not found")
